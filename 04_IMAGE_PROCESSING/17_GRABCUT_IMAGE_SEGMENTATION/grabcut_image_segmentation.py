...
cv.rectangle(img, (int(r[0]), int(r[1])), (int(r[0])+int(r[2]), int(r[1])+int(r[3])), (0, 255, 0), 2)
...
# Bir alanı seçip enter basınca seçili alan ayrı bir pencerede arkası temizlenmiş şekilde çıkıyor.
